...
import static eu.ha3.presencefootsteps.PresenceFootsteps.*;

@EventBusSubscriber(modid = PresenceFootsteps.MOD_ID)
public class ModLifecycleEventSubscriber {
    ...
    @SubscribeEvent
    public static void onRegisterClientReloadListeners(final AddClientReloadListenersEvent event) {
        ...
        event.addListener(ResourceLocation.fromNamespaceAndPath(MOD_ID, "soundengine"), getInstance().engine);
    }
